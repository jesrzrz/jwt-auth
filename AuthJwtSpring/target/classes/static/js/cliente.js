(function () {
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                if (jqXHR.status === 401) {
                    $('#loginErrorModal')
                        ...
                        .find(".modal-body")
                        .empty()
                        .html("<p>Exception:<br>" + jqXHR.responseJSON.exception + "</p>");
                } else {
                    throw new Error("Ha ocurridoError inesperado: " + errorThrown);
                }
            }
        });
    }
    ...
    function showUserInformation() {
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $userInfoBody.append($("<div>").text("Usuario: " + data.username));
    ...
    function showTokenInformation() {
        ...
        $loggedInBody.append($("<h4>").text("Claims del token"));
